...
import io.helidon.jenkins.publisher.plugin.config.HelidonPublisherProjectProperty;
import io.helidon.jenkins.publisher.plugin.config.HelidonPublisherServer;
